...
// renderer
#define RENDERER_SPRITE_MEMORY_WIDTH 25000
#define RENDERER_SPRITE_MEMORY_HEIGHT 25000
#define RENDERER_FONT_MEMORY_WIDTH 5000
#define RENDERER_FONT_MEMORY_HEIGHT 5000
#define RENDERER_MAXIMUM_FONT_COUNT 2

// network
#define NETWORK_HOST "ec2-18-199-121-195.eu-central-1.compute.amazonaws.com"
